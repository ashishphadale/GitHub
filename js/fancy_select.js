var fancyselect = angular.module('ionicApp', ['ionic']).directive('fancySelect', 
    [
        '$ionicModal',
        function($ionicModal) {
            return {
...
fancyselect.config(function($stateProvider, $urlRouterProvider) {
...
fancyselect.controller('MainCtrl', function($scope) {
  $scope.countries = [
